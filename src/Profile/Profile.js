...
export function Posts(props) {
    return (
        <div className='Posts grid grid-cols-3 gap-1'>
            <img src='https://jammincoder.github.io/Instaclone/img/posts/cpp.png' className='aspect-square border border-gray-700 w-[100%]'/>
            <img src='https://jammincoder.github.io/Instaclone/img/posts/python.png' className='aspect-square border border-gray-700 w-[100%]'/>
            <img src='https://jammincoder.github.io/Instaclone/img/posts/js.png' className='aspect-square border border-gray-700 w-[100%]'/>
            <img src='https://jammincoder.github.io/Instaclone/img/posts/react.png' className='aspect-square border border-gray-700 w-[100%]'/>
        </div>
    );
}
